...
//This function performs matrix addition for two input matrices matrix_A and matrix_B and stores the result in matrix_C.
// The parameter split_index specifies the size of the matrices being added, as this code works with sub-matrices.
...
//creating a empty matrix result matrix with row=col_2 and col=row_1    vector<int> result_matrix_row(col_2, 0);
   vector<int> result_matrix_row(col_2, 0);
  vector<vector<int> > result_matrix(row_1,result_matrix_row);
 
//trivial condition where the matrix has only one column
    if (col_1 == 1)
        result_matrix[0][0]
 ...
 //creating sub matrix of 2X2
        ...
        vector<vector<int> > result_matrix_11(split_index,
                                              row_vector);
 //split input matrix into smaller portions
